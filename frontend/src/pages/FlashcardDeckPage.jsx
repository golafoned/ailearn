...
export function FlashcardDeckPage() {
    ...
    const handleDeleteCard = async (cardId) => {
        try {
            await apiFetch(
                `/api/v1/flashcards/decks/${deckId}/cards/${cardId}`,
                {
                    method: "DELETE",
                },
            );
    ...
    const handleGenerate = async (e) => {
        ...
        try {
            const result = await apiFetch(
                `/api/v1/flashcards/decks/${deckId}/generate`,
                {
                    method: "POST",
        ...
        <div className="max-w-4xl mx-auto page-shell">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
                ...
                <div className="flex flex-wrap gap-2">
                    ...
                    >
                        {studyLoading ? "Loading..." : "📖 Study All"}
                    </Button>
                </div>
            </div>
                    ...
                    {deck.cards && deck.cards.length > 0 ? (
                        <div className="space-y-3">
                            {deck.cards.map((card, idx) => (
                                <div
                                    key={card.id}
                                    className={`bg-white rounded-lg border p-4 ${card.isDue ? "border-orange-300 bg-orange-50" : "border-gray-200"}`}
                                >
                        ...
                        <div className="text-center py-12 bg-gray-50 rounded-xl border border-gray-200">
                            ...
                            <p className="text-gray-600">
                                No cards yet. Add cards manually or use AI
                                generation!
                            </p>
                        </div>
                    )}
                        ...
                        <div className="max-w-2xl mx-auto">
                            ...
                            >
                                {!showBack ? (
                                    ...
                                    <>
                                        <span className="text-xs uppercase tracking-wider text-green-500 mb-4">
                                            Answer
                                        </span>
                ...
                <div className="max-w-xl mx-auto">
                    <div className="bg-gradient-to-br from-purple-50 to-indigo-50 rounded-xl border border-purple-200 p-8">
                        ...
                        <p className="text-gray-600 mb-6">
                            Enter a topic and AI will generate flashcards for
                            you using spaced repetition-optimized content.
                        </p>
