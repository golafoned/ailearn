...
export function HomePage() {
    ...
    const features = [
        { emoji: "🤖", title: "AI-Powered Tests", desc: "Generate practice tests on any topic instantly" },
        { emoji: "🃏", title: "Flashcards", desc: "Study with AI-generated flashcards and spaced repetition" },
        { emoji: "📊", title: "Adaptive Learning", desc: "AI adjusts difficulty based on your mastery level" },
        { emoji: "🏆", title: "Track Progress", desc: "Earn achievements and watch your knowledge grow" },
        { emoji: "🔄", title: "Spaced Repetition", desc: "Review at optimal intervals for long-term retention" },
        { emoji: "📚", title: "Concept Mastery", desc: "Deep-dive into individual concepts with targeted practice" },
    ];
        ...
        <div className="relative isolate overflow-hidden min-h-screen">
            ...
            <div className="flex items-center justify-center text-center px-6 pt-28 sm:pt-36 lg:px-8">
                <div className="mx-auto max-w-4xl">
                    <h1 className="text-4xl font-extrabold tracking-tight text-gray-900 sm:text-6xl mb-6">
                        ...
                        <span className="bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent"> AI-Powered Learning</span>
                    </h1>
                    <p className="mt-4 text-xl leading-8 text-gray-600 mb-10 max-w-2xl mx-auto">
                        Practice tests, flashcards, and adaptive study sessions — all powered by AI.
                        Learn faster through spaced repetition and smart feedback.
                    </p>

                    <div className="bg-white/60 backdrop-blur-md p-8 rounded-2xl shadow-xl border border-white/50 space-y-8 max-w-2xl mx-auto">
                        {/* Quick Practice Form */}
                        <form onSubmit={handleQuickPractice} className="relative">
                            <div className="flex flex-col sm:flex-row gap-3">
                                ...
                                >
                                    Start Learning <IconArrowRight className="ml-2 w-5 h-5" />
                                </Button>
                            </div>
                        </form>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                            {/* Join by Code */}
                            <form onSubmit={handleJoinTest} className="flex gap-2 sm:col-span-2">
                                <input
                                    type="text"
                                    value={joinCode}
                            ...
                            {isAuthenticated ? (
                                <Button onClick={() => navigate("/learning")} variant="secondary" className="w-full justify-center py-3">
                                    My Learning →
                                </Button>
                            ) : (
            ...
            <div className="max-w-6xl mx-auto px-6 py-20">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {features.map((f) => (
                        <div key={f.title} className="bg-white/70 backdrop-blur-sm rounded-xl border border-gray-200 p-6 hover:shadow-md transition-shadow">
            ...
            {!isAuthenticated && (
                <div className="max-w-2xl mx-auto px-6 pb-20 text-center">
                    <div className="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl p-8 text-white">
                        ...
                        <p className="text-blue-100 mb-6">Create a free account to track your progress, earn achievements, and unlock all features.</p>
                        <Button
